...
The Jupyter Notebook for the Udacity AIND NLP concentration machine translation capstone project is available on GitHub:<br/>
...
A Jupyter Notebook teaching a TensorFlow-based implementation of the word2vec algorithm for word embeddings is available from the Udacity Deep Learning Foundation program:</br>
